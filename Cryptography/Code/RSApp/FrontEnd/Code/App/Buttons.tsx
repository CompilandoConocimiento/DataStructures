...
const Buttons: FC = () => {
  const style = { display: "grid", gridAutoFlow: "column", gridGap: "1rem", marginBottom: "2rem", overflow: "scroll" }
  ...
  return (
    <section style={style}>
      ...
      <Button target="#Hash" type="info" name="Create Signature" />
      <Button target="#Compare" type="info" name="Check Signature" />
    </section>
  )
}
